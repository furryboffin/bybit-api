...
const {signMessage} = require('./util/requestUtils.js');


const wsUrls = {
  livenet: 'wss://stream.bybit.com/realtime',
  livenet_usdt: 'wss://stream.bybit.com/realtime_public',
  testnet: 'wss://stream-testnet.bybit.com/realtime',
  testnet_usdt: 'wss://stream-testnet.bybit.com/realtime_public'
};
...
module.exports = class WebsocketClient extends EventEmitter {
  ...
  async _connect() {
    try {
      ...
      const url = wsUrls[this.options.livenet ? ( this.options.usdt ? 'livenet_usdt' : 'livenet' ): ( this.options.usdt ? 'testnet_usdt' : 'testnet')] + authParams;
